...
export default function PhoneNumberVerification() {
  ...
  return (
    <>
      <div className="lg:h-screen flex flex-col lg:flex-row">
        ...
        <div className="lg:bg-primary-50 lg:w-2/5">
          ...
          <div className="hidden lg:flex flex-col justify-center items-center mt-10 ">
            {/* Image */}
            <img
              className="hidden lg:flex h-[324px] w-[402px] rounded-[8px] object-cover "
              src="PhoneVerificationPageImg.png"
              alt=""
            />
            {/* Text */}
            <p className="text-[18px] leading-[30px] text-center text-neutral-600 mt-[48px] lg:w-[366px] mx-auto font-campton ">
        ...
        <div className="lg:w-3/5 flex flex-col justify-center py-5 px-2 md:px-10 lg:px-20">
          ...
          <div className="flex flex-col items-center justify-center">
            <h1 className=" text-[22px] md:text-[30px] leading-[27.2px] font-bold text-center font-cabinetGrotesk">
              Phone Number Verification
            </h1>
            <img
              className="h-[3.9px] md:h-[6.2px] w-[60px] md:w-[80px] "
              src="arrow.png"
              alt=""
            />
          </div>
          ...
          <div className="my-[24px]">
            <p className="text-[15px] md:text-[18px] leading-[28px] font-medium text-left font-campton">
              We sent a 4-digit code to{" "}
              <span className=" text-secondary-500 ">+234 813********34.</span>{" "}
              Code expires in <span className="font-bold">10 minutes</span>
            </p>
          </div>
          ...
          <div className="">
            <h1 className="text-[16px] leading-[19px] font-medium font-campton">
              Verification Code
            </h1>
          ...
          <div className="my-4">
            <h1 className="text-[14px] md:text-[16px] leading-[24px] font-campton">
              Didn’t get a code?{" "}
          ...
          <div className="mx-5">
            <button
              className="bg-primary-500 w-full text-center text-white text-[17px] md:text-[18px] leading-[24px] font-bold rounded-[8px] py-[18px] font-campton"
              type="submit"
          ...
          <div className="mt-10 ">
            <h1 classname="text-[16px] leading-[24px] text-neutral-900 font-medium font-campton">
              Already have an account?{" "}
              <span className="text-[18px] text-primary-500 font-bold">
                <a href="#">Log In</a>
              </span>
            </h1>
          </div>
      ...
      {/* Successfull Modal */}
      <PhoneNumberVerificationSuccessfullUI
        open={openModal}
