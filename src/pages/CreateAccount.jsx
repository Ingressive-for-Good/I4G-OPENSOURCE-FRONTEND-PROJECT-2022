    ...
    <div className="bg-neutral-50 px-5 py-11 md:px-20 md:py-10 lg:p-0 text-neutral-900 font-campton">
      ...
      <main className="flex items-stretch">
        <section className="hidden w-2/5 lg:flex flex-col justify-around  bg-primary-50 pt-12 pb-24 px-11 xl:px-12">
          <h1 className="font-cabinetGrotesk text-3xl font-bold text-primary-500 justify-self-start self-start xl:pl-10 pl-8">
            tech<span className="text-secondary-500">mart</span>
          </h1>

          <img src={Main} alt="Main Image" className="mt-24" />

          <p className="text-center lg:mt-3 xl:mt-6 leading-8  text-neutral-600 text-lg">
        ...
        <section className="flex justify-center w-screen pt-6 pb-5 md:pt-10 md:pb-9 lg:w-3/5 lg:pt-14 lg:pb-16">
          <div className="w-full lg:w-4/5 xl:w-3/4">
            <h2 className="font-cabinetGrotesk font-bold text-center text-xl md:text-3xl lg:mt-8 xl:mt-6">
              Create An Account
            </h2>
            <img
              src={Line}
            ...
            <form className="pt-6">
              <label for="fullName" className="font-medium leading-5">
                Full Name
              </label>
              <br />
              ...
              <input
                ...
                className="mt-2 mb-6 md:mb-5 bg-neutral-50 border-2 rounded-lg py-5 px-4 w-full border-neutral-500 placeholder:text-neutral-800 placeholder:leading-5"
              />
              <br />

              <label for="email" className="font-medium leading-5">
                Email Address
              </label>
              <br />
              ...
              <label for="password" className="font-medium leading-5">
                Password
              </label>
              <br />
