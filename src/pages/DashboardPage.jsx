...
function DashboardPage() {
  ...
  const [open, setNotificationDialog] = useState(false);
        ...
        <div className="flex flex-col">
          ...
          <div>
            ...
            <div className="hidden gap-4 items-center md:flex">
              ...
              {/* notification icon */}
              <div
                className=" bg-gray-300 rounded-full p-3 hover:bg-primary-100 cursor-pointer "
                onClick={() => setNotificationDialog(!open)}
              >
                <svg
                  width="26"
                  height="26"
          ...
          <div className=" absolute top-[40px] z-100">
