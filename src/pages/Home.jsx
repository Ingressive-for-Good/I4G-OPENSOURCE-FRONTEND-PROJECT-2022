  ...
  return (
    <div id="body" className="text-neutral-900 font-campton">
      ...
      <header className="relative bg-primary-50 px-8 py-9 flex items-center justify-between">
        ...
        <nav
          id="nav"
          className="h-screen lg:h-fit w-screen lg:w-fit hidden absolute lg:relative z-100 top-0 lg:top-unset left-0 lg:left-unset bg-white lg:bg-transparent lg:flex flex-col lg:flex-row space-y-8 lg:space-y-0 justify-center items-center lg:space-x-5 text-neutral-700"
        >
          <img
