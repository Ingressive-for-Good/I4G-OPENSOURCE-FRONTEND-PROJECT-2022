  ...
  if (showSuccess) {
    ...
    menumask = (
      <div
        ...
        className="absolute top-0 left-0 bg-black-t-50 w-screen h-full"
      ></div>
    );
  }
    ...
    <div>
      ...
      <div className="flex">
        <div className="hidden md:block relative -top-28 px-24 pt-40 w-[550px] bg-primary-50 content-center h-[110vh]">
          <img
            src="../src/assets/images/laptop-woman.png"
            alt="laptop-woman"
            width={350}
          />
          <p className="font-campton text-neutral-600 text-[15px] font-normal text-center py-5 pb-20">
        ...
        <div className=" mx-auto">
          <div className="pt-4 text-center items-center content-center leading-5">
            <h1 className="font-cabinetGrotesk text-[30px] font-bold">
              Reset Password
            </h1>
            <img
          ...
          <p className="px-6 pt-8 font-campton text-[15px] font-normal">
            Your new password should be different from the previously used
            passwords.
          </p>
          <PasswordResetForm />
          ...
          <p className="text-center font-campton pt-16">
