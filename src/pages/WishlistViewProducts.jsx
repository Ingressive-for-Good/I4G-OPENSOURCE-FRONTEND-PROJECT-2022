...
import productOne from "../assets/images/Rectangle 12dell.png";
import productTwo from "../assets/images/Rectangle 14GamePad.png";
import productThree from "../assets/images/image 2macbook.png";
    ...
    <div className="md:bg-gray-50">
      ...
      <div className="flex px-6 pb-3 pt-6 justify-between md:ml-64 leading-tight">
        ...
        <button onClick={() => setShowSelect(!showSelect)}>
          ...
          >
            <path
              d="M2.09091 3.18182C2.6934 3.18182 3.18182 2.6934 3.18182 2.09091C3.18182 1.48842 2.6934 1 2.09091 1C1.48842 1 1 1.48842 1 2.09091C1 2.6934 1.48842 3.18182 2.09091 3.18182Z"
              stroke="black"
              stroke-width="1.5"
            ...
            />
            <path
              d="M2.09091 11.1818C2.6934 11.1818 3.18182 10.6934 3.18182 10.0909C3.18182 9.48842 2.6934 9 2.09091 9C1.48842 9 1 9.48842 1 10.0909C1 10.6934 1.48842 11.1818 2.09091 11.1818Z"
              stroke="black"
              stroke-width="1.5"
              stroke-linecap="round"
              stroke-linejoin="round"
            />
            <path
              d="M2.09091 19.1818C2.6934 19.1818 3.18182 18.6934 3.18182 18.0909C3.18182 17.4884 2.6934 17 2.09091 17C1.48842 17 1 17.4884 1 18.0909C1 18.6934 1.48842 19.1818 2.09091 19.1818Z"
              stroke="black"
              stroke-width="1.5"
              stroke-linecap="round"
              stroke-linejoin="round"
      ...
      <div className="flex flex-wrap md:ml-64">
        ...
        <div className=" gap-4 border-2 rounded-md m-6 p-6 bg-gray-50 w-[490px] sm:flex md:bg-none">
          <div>
            <img src={productOne} alt="product-image" width={230} />
          </div>
          <div className="font-cabinetGrotesk leading-[40px]">
            <p className="font-semibold text-[16px]">Dell Keyboard & Mouse.</p>
            <h1 className="font-bold text-[18px]  md:text-[21px]">
              ₦25,000.00
            </h1>
            <p className="font-campton font-medium text-[15px] md:text-[16px] text-gray-500">
              Workspace Equipment.
            </p>
            <a
              className="underline text-primary-500 font-bold text-[16px] md:text-[18px]"
              href="#"
            >
              <p>View Details</p>
            </a>
        ...
        <div className=" gap-4 border-2 rounded-md m-6 p-6 bg-gray-50 w-[490px] sm:flex md:bg-none">
          <div>
            <img src={productTwo} alt="product-image" width={230} />
          </div>
          <div className="font-cabinetGrotesk leading-[40px]">
        ...
        <div className=" gap-4 border-2 rounded-md m-6 p-6 bg-gray-50 w-[490px] sm:flex md:bg-none">
          <div>
            <img src={productThree} alt="product-image" width={230} />
          </div>
          <div className="font-cabinetGrotesk leading-[40px]">
