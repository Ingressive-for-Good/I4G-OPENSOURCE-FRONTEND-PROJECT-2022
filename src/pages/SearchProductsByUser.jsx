...
function SearchProductsByUser() {
    ...
    if(showProduct){
        products = <div className="font-cabinetGrotesk border-2 border-collapse rounded-lg w-[90%] md:w-[100%] mt-16 mx-auto md:mx-0 text-center">
                        <div className="flex items-center justify-between px-6 py-4 bg-blue-50">
                            <p className=" font-bold text-[18px]">24 Result(s) Found</p>
                        ...
                        <div className="flex items-center border-t-2 border-b-2">
                            <p onClick={() => clickFunctionTwo()} className="bg-blue-50 p-4 border-r-2 font-semibold cursor-pointer">Product(s) by Nora</p>
                            <p onClick={() => clickFunctionOne()} className="p-4 border-r-2 cursor-pointer">Users</p>
                        </div>
    ...
    if(showUser){
        users = <div className="font-cabinetGrotesk border-2 border-collapse rounded-lg w-[90%] md:w-[100%] mt-16 mx-auto md:mx-0 text-center">
                    <div className="flex items-center justify-between px-6 py-4 bg-blue-50">
                        <p className=" font-bold text-[18px]">24 Result(s) Found</p>
                        <p className="flex items-center gap-2">
                            Sort by: <span className=" text-blue-700">Latest</span><img onClick={() => setShowSort(!showSort)} src={chevronDown} alt="" />
                    ...
                    <div className="flex items-center border-t-2 border-b-2">
                        ...
                        <p className="bg-blue-50 font-semibold p-4 border-r-2 cursor-pointer">Users</p>
                    </div>
                    <table className="w-[100%]">
                            <tr className="border-b-2 rounded-t-lg">
...
export default SearchProductsByUser;