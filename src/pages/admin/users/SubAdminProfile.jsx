...
function SubAdminProfilePage() {
  return (
    <div>
      ...
      <div className="flex justify-between md:mt-12 items-center">
        <div className="px-6 md:px-0">
          ...
          <div className="font-cabinetGrotesk ">
            ...
            <h1 className="font-bold text-[28px]">Sub admin profile</h1>
          </div>
        </div>
      ...
      <div>
        <p className=" text-blue-800 text-[18px] font-medium font-cabinetGrotesk px-6 py-4 md:px-0">
          Account Information
        </p>
      </div>
      ...
      <div className="px-6 mt-10 md:px-0 font-cabinetGrotesk">
        <div className="flex items-center justify-between">
          ...
          <p className="flex items-center gap-4 text-blue-700">
            <img src={plusIcon} alt="" /> Assign Task
          </p>
        </div>
        <p>No activity</p>
      </div>
      ...
      <div className="hidden fixed top-[365px] left-0 md:flex gap-3 bg-white p-4 items-center w-[230px]">
        ...
        <p className=" font-cabinetGrotesk text-blue-700 font-semibold text-[18px]">
          Users
        </p>
      </div>
    </div>
