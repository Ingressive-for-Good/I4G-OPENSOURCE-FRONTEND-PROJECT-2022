...
export default function TermsOfSevice() {
  return (
    <div id="body">
      <MainNav/>
        ...
        <div className="w-full pt-[46px]">
          ...
          <div className="flex flex-col gap-[40px] pb-[100px] lg:pr-[64px]">
            <div className="flex flex-col gap-[20px]  pl-[17px]">
              <h4 className="text-neutral-900 font-[700] font-cabinet sm:text-[28px] text-[20px]">Privacy and Legal Policy Statement</h4>
            ...
            <div className="flex flex-col gap-[20px] pl-[17px]">
              <h4 className="text-neutral-900 font-[700] font-cabinet sm:text-[28px] text-[20px]">Our Privacy Policy</h4>
              <div className="text-[18px] font-[400] font-campton leading-8 flex flex-col gap-[10px]">
                <div>
                <p>
