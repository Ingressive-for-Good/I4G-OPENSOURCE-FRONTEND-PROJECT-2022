...
export default function SideBar() {
  return (
    <aside className='fixed top-0 left-0 h-screen bg-primary-50 w-[230px] pt-[50px] hidden lg:block'>
      <h1 className='text-[32px] text-primary-500 pl-[50px] pb-[38px] text-primary-500'>tech<span className='text-secondary-500'>mart</span></h1>
