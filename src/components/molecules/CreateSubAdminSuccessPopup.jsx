  ...
  return (
    <div>
      <div className="fixed bg-white top-[20%] right-[2%] md:right-[30%] max-w-md align-middle justify-center text-center border rounded-lg z-20 shadow-lg p-4 m-4">
        ...
        <p className="font-cabinetGrotesk">
          Send sub-admin account details to email
        </p>
        ...
        <p className="font-campton px-6">
          The reciever of this email will be a sub-admin, and will have access
          to Techmart database. <br /> Do you wish to continue?
        </p>
