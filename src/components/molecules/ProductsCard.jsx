    ...
    <div className="mb-12 max-w-[340px] min-h-[380px] border-2 border-neutral-300 rounded-lg">
      <div className="max-w-[340px] relative h-[220px] bg-neutral-300 ">
        <img
          ...
          alt=""
          className="h-[220px] object-cover grid place-items-center"
        />
        <p
          onClick={() => {
        ...
        <div className={ToggleEdit()}>
          ...
          <p onClick={() => dispatch(setAvailability(products.id))}>
            Mark as Available
          </p>
        </div>
      </div>
      <div className="flex justify-between items-center">
        <div className="ml-6 my-3">
          <p className="font-campton text-lg text-[#4B4E61]  pb-1">
            {products.productName}
          </p>
          <p className="font-campton text-[#717591] pb-1">
            {products.description}
          </p>
          <p className="font-grotesk text-[#131418] text-xl pb-1 font-bold">
            {products.price}
          </p>
          <p className="font-campton text-[#AB5004] pb-1">
            {products.availability ? "Available" : "Unavailable"}
          </p>
        </div>
