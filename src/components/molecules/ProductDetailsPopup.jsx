...
function ProductDetailsPopup() {
  return (
    <div className="fixed top-[8%] md:top-[5%]  md:right-[28%] bg-gray-100 border p-6 m-6 font-cabinetGrotesk md:w-[500px] align-middle">
      <img
        className="absolute top-2 right-4 md:right-2 m-2 md:left-[410px] pb-2"
        src="../src/assets/icons/CloseSquare.svg"
        alt=""
        width={30}
      />
      ...
      <div className="flex justify-between pt-6">
        <div>
          ...
          <small className="text-[15px] font-semibold text-gray-400">
            Category
          </small>
        </div>
      ...
      <div className="pt-6">
        ...
        <p className="text-[14px] md:text-[16px]">
          ...
          laborum nobis laboriosam rerum harum placeat sequi, autem cumque? Rem,
          ipsa sequi possimus consectetur voluptatum impedit?
        </p>
      </div>
