  ...
  return (
    <div className=" absolute top-0 flex font-normal pb-28 pt-20  text-gray-400 text-sm w-56 p-4 justify-center">
      <ul className="font-campton">
        <li className=" absolute top-0 pt-24  text-[16px] font-semibold w-56 pl-11 p-4 text-blue-800 bg-gray-200">
          Menu
        </li>
        ...
        <li className="flex font-medium text-[17px] w-56 pl-11 p-4 bg-gray-200 gap-2 items-center">
          ...
          >
            ...
            />
            <path
              d="M9.89997 12.7899L4.04997 9.8699C3.59997 9.6399 3.07997 9.6699 2.64997 9.9299C2.21997 10.1899 1.96997 10.6499 1.96997 11.1499V16.6799C1.96997 17.6399 2.49997 18.4999 3.35997 18.9299L9.20997 21.8499C9.40997 21.9499 9.62997 21.9999 9.84997 21.9999C10.11 21.9999 10.37 21.9299 10.6 21.7799C11.03 21.5199 11.28 21.0599 11.28 20.5599V15.0299C11.29 14.0799 10.76 13.2199 9.89997 12.7899Z"
              fill="#A1A4B6"
            />
            <path
              d="M22.03 11.1499V16.6799C22.03 17.6299 21.5 18.4899 20.64 18.9199L14.79 21.8499C14.59 21.9499 14.37 21.9999 14.15 21.9999C13.89 21.9999 13.63 21.9299 13.39 21.7799C12.97 21.5199 12.71 21.0599 12.71 20.5599V15.0399C12.71 14.0799 13.24 13.2199 14.1 12.7899L16.25 11.7199L17.75 10.9699L19.95 9.86988C20.4 9.63988 20.92 9.65988 21.35 9.92988C21.77 10.1899 22.03 10.6499 22.03 11.1499Z"
              fill="#A1A4B6"
            />
            <path
              d="M17.61 9.16L16.13 9.95L6.62 4.6L8.18999 3.75L17.37 8.93C17.47 8.99 17.55 9.07 17.61 9.16Z"
              fill="#A1A4B6"
            />
            <path
        ...
        <li className="flex font-medium text-[17px] w-56 pl-11 p-4 bg-gray-200 gap-2 items-center">
          ...
          >
            ...
            />
            <path
              d="M13.567 15.048V14.668C13.567 12.312 17.139 12.198 17.139 9.291C17.139 7.125 15.6 6.08 13.168 6.08C10.318 6.08 8.361 7.828 8.608 10.241L10.413 11.533C10.128 9.215 11.325 8.113 13.016 8.113C14.27 8.113 14.84 8.664 14.84 9.5C14.84 11.419 11.553 11.609 11.553 14.497V15.048H13.567ZM13.757 19V16.302H11.325V19H13.757Z"
              fill="#FAFAFB"
            />
          </svg>
          Help & Support
