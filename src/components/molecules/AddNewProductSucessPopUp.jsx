      ...
      <div className="bg-white opacity-[1] w-[90%] sm:w-[80%] lg:w-[70%] max-w-[590px] mx-auto p-[30px] sm:p-[47px] mx-auto font-campton rounded-[8px]">
        <div className="flex flex-col items-center justify-center text-center ">
          ...
          <div className="flex sm:flex-row flex-col justify-between w-full mt-[32px] gap-[15px]">
            <button
              onClick={handleClick}
              className="border border-primary-500 py-[18px] border-[2px] w-[100%] sm:w-[45%] text-center rounded-[8px] font-[700] text-primary-500"
            >
              Go to dashboard
            </button>
            <button
              onClick={handleClick}
              className="border border-primary-500 py-[18px] border-[2px] w-[100%] sm:w-[45%] text-center rounded-[8px] font-[700] text-white bg-primary-500"
            >
              View Product
            </button>
          </div>
