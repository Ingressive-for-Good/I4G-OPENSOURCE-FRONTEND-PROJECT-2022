  ...
  return (
    <div className="absolute inset-0 bg-black/25 w-screen h-screen flex items-center justify-center">
      <div className="bg-neutral-50 w-[300px] md:w-[590px] mx-auto flex flex-col items-center px-2 md:px-10 py-[40px] rounded-[8px]">
        {/* text */}
        <h1 className="text-[20px] md:text-[30px] leading-[24px] md:leading-[37.2px] text-secondary-500 font-bold font- font-cabinetGrotesk ">
        ...
        <p className="text-neutral-700 md:text-neutral-800 text-[16px] md:text-[18px] text-center leading-[31px] font-normal font-campton ">
          Are you sure you want to suspend this account? This action can be
          undone.
        </p>
        {/* buttons */}
