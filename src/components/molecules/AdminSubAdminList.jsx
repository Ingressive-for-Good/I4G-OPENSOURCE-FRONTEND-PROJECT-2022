import { SubAdminListData } from "../../assets/data/data";
...
export default function AdminSubAdminList() {
  return (
    <div className="flex flex-col mt-[50px]">
      ...
      <div className="flex flex-col w-full  font-cabinetGrotesk border border-neutral-500 rounded-[8px]">
        <div className="flex flex-row justify-between items-center p-[20px] bg-primary-50">
          ...
          <Link className="flex flex-row text-primary-500 font-cabinetGrotesk font-[700] gap-[12px]">
        ...
        <div>
          <div className="border-b border-neutral-500 flex flex-row font-[700]  py-[16px] ">
            <span className="lg:w-[25%] md:w-[33%] w-[50%] pl-[20px]">
              Name
            </span>
            <span className="lg:w-[25%] md:w-[33%] w-[50%]">Email Adress</span>
            <span className="hidden md:inline lg:w-[25%] md:w-[33%] w-[50%]">
              Phone Number
            </span>
          ...
          {SubAdminListData &&
            SubAdminListData.map((user) => (
              <div
                className="relative text-left border-b border-neutral-500 font-campton text-[14px] sm:text-[16px] flex flex-row items-center py-[8px] "
                key={user.id}
              >
                ...
                <span className="lg:w-[25%] md:w-[33%] w-[50%]">
                  {user.Email}
                </span>
                <span className="hidden md:inline lg:w-[25%] md:w-[33%] w-[50%]">
                  {user.Phone}
                ...
                <img
                  className="absolute top-[30%] right-[20px]"
                  src={infoIcon}
                  alt="infoicon"
                />
              </div>
      ...
      <div className="font-capmton font-[500] flex flex-row justify-between mt-[50px]">
        <div>
          <span>Showing 2 of 2 Sub-admin(s)</span>
        </div>
