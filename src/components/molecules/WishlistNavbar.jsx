    ...
    <div className="flex justify-center">
      <div className="w-[335px] flex-row md:w-[584px] lg:w-[1062px]">
        ...
        <div className="flex justify-between mt-[45px] border-b-[1.2px] border-neutral-500 pb-2">
          <h2 className="font-medium text-[14px] text-primary-500 cursor-pointer">
            Select All
          </h2>
          ...
          >
            <span>
              ...
              >
                <path
                  d="M1.86462 5.16479C1.30634 4.42041 1.83747 3.35815 2.76793 3.35815H13.1085C14.039 3.35815 14.5701 4.42041 14.0118 5.16479L13.5179 5.82334C13.1107 6.36626 12.8906 7.0266 12.8906 7.70525V14.0553C12.8906 15.4411 11.7672 16.5645 10.3814 16.5645H5.49505C4.10925 16.5645 2.98584 15.4411 2.98584 14.0553V7.70525C2.98584 7.0266 2.76572 6.36626 2.35854 5.82334L1.86462 5.16479Z"
                  stroke="#A1A4B6"
                  strokeWidth="1.25461"
                />
                <path
                  d="M9.58899 11.3944L9.58899 6.82666"
                  stroke="#A1A4B6"
                  strokeWidth="1.25461"
                  strokeLinecap="round"
                ...
                />
                <path
                  d="M6.28711 11.3944L6.28711 6.82666"
                  stroke="#A1A4B6"
                  strokeWidth="1.25461"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                />
                <path
                  d="M11.2399 3.35803L10.7005 1.7397C10.5297 1.22739 10.0503 0.881836 9.51024 0.881836H6.36639C5.82637 0.881836 5.34693 1.22739 5.17616 1.7397L4.63672 3.35803"
                  stroke="#A1A4B6"
                  strokeWidth="1.25461"
                  strokeLinecap="round"
                />
            ...
            <h2 className="font-semibold text-base ml-[15.63px] cursor-pointer">
              Delete
            </h2>
          </div>
        </div>
