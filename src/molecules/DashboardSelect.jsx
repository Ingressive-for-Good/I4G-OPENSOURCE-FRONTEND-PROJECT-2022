    ...
    <div className="border bg-white rounded-md w-[296px] absolute left-44  md:left-[1020px]">
        <div className="flex p-2 items-center justify-between border-b m-2">
          ...
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <rect x="0.0390625" y="0.0390625" width="23.9219" height="23.9219" stroke="#4B4E61" stroke-width="0.078125"/>
          </svg>

        </div>
        <div className="flex justify-between p-2 items-center m-2">
          <p>Sort By</p>
            <svg onClick={() => setShowSort(!showSort)} width="15" height="8" viewBox="0 0 15 8" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M1.5 1L7.5 7L13.5 1" stroke="#4B4E61" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
        </div>
        <div>
          { sort }
