...
export default function PhoneNumberVerificationSuccessfullUI() {
  return (
    ...
    <div className='bg-neutral-50 mx-[20px] md:mx-[77px] lg:mx-[425px] flex flex-col items-center px-2 md:px-10 py-[40px] rounded-[8px]'>
      ...
      {/* button */}
      <button className='bg-primary-500 px-[31px] py-[18px] rounded-[8px] mt-[24px] text-[18px] leading-[24px] font-campton font-bold text-white' type="submit">Proceed to Dashboard</button>
    </div>
  </div>
    )
}
