    ...
    <div className="text-neutral-900 font-campton">
      ...
      <main>
        ...
        <section className="px-[10%] py-4 text-center bg-primary-50">
          <h1 className="font-cabinetGrotesk font-bold text-3xl sm:text-4xl lg:text-5xl my-3 sm:max-w-md md:max-w-lg sm:mx-auto">Buy, Sell & Swap Quality Items for techies - all in
          ...
          <div className="sm:w-fit sm:mx-auto sm:flex sm:justify-center lg:my-8">
        ...
        <section className="w-fit mx-auto px-6 py-3 rounded-lg my-5 text-center">
            ...
            <div className="space-y-4 my-8 mx-auto lg:flex lg:justify-between lg:items-center lg:w-5/6">
                ...
                <img className="lg:rotate-90 mx-auto" src="src/images/landingpage__wavy-dashed.svg" alt="" />
        ...
        <section className="w-fit mx-auto px-6 py-3 rounded-lg my-5 lg:my-12 text-center">
            ...
            <div className="space-y-4 my-8 lg:flex lg:justify-between lg:items-center lg:w-5/6 mx-auto">
                ...
                <img className="lg:rotate-90 mx-auto lg:mr-8" src="src/images/landingpage__wavy-dashed.svg" alt="" />
                <div className="max-w-xs mx-auto">
                ...
                <img className="lg:rotate-90 mx-auto lg:mx-8" src="src/images/landingpage__wavy-dashed.svg" alt="" />
                <div className="max-w-xs mx-auto">
      ...
      <section className="w-5/6 mx-auto">
        ...
        <p className="text-neutral-700 text-center my-5">View a few products from our techies</p>
        ...
        <button className="flex my-6 bg-primary-500 rounded-lg px-6 py-4 font-semibold text-white mx-auto w-fit">See More</button>
      </section>
